...
import WatermelonJSON from "/public/img/animation_ljzefsxj.json";
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="img/makna_lambang.jpg" class="h-8 mr-3" alt=" Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Aditya Ananta</span>
            </a>
